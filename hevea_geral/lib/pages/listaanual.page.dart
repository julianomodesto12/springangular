...
class ListaAnualPage extends StatefulWidget {

  final Usuario usuario;

  int pid_atividade ;

  ListaAnualPage(this.usuario );

  @override
  _ListaAnualPageState createState() =>
      new _ListaAnualPageState();
}

class _ListaAnualPageState extends State<ListaAnualPage> {

  GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();

  List<AnualHevea> items = new List();
...
*/
  ...
  void _gerarLista(String pfazenda  , int ptarefa) async {
    ...
    List<AnualHevea> listAnual = await db.getAllResumoAnual( pfazenda , ptarefa );
    listAnual.toList();
    listAnual.forEach((elemento) {
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  Padding(
                                    ...
                                    //a.id_anh, a.tarefa_anh, a.cortes_anh, a.coord_anh
