...
class Atividade {
  ...
  factory Atividade.fromMap(Map<String, dynamic> json) => new Atividade(
  ...
  Atividade AtividadeFromJson(String str) {
    final jsonData = json.decode(str);
    return Atividade.fromMap(jsonData);
  }

  String AtividadeToJson(Atividade data) {
